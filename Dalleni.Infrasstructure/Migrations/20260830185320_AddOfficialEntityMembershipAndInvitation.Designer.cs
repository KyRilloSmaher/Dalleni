...
namespace Dalleni.Infrastructure.Migrations
{
    ...
    [Migration("20260830185320_AddOfficialEntityMembershipAndInvitation")]
    partial class AddOfficialEntityMembershipAndInvitation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dalleni.Domin.Models.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dalleni.Domin.Models.OfficialEntityMembership", b =>
                {
                    ...
                    b.HasOne("Dalleni.Domin.Models.ApplicationUser", "User")
                        .WithMany("OfficialEntityMemberships")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dalleni.Domin.Models.Rating", b =>
                {
                    b.HasOne("Dalleni.Domin.Models.Service", "Service")
                        .WithMany("Ratings")
            ...
            modelBuilder.Entity("Dalleni.Domin.Models.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("OfficialEntityMemberships");
