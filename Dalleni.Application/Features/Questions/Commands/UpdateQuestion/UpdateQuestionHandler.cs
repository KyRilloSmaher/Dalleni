...
{
    public class UpdateQuestionHandler : IRequestHandler<UpdateQuestionCommand, Response<bool>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IResponseHandler _responseHandler;
        private readonly ILogger<UpdateQuestionHandler> _logger;

        public UpdateQuestionHandler(IUnitOfWork unitOfWork, IResponseHandler responseHandler, ILogger<UpdateQuestionHandler> logger)
        {
        ...
        public async Task<Response<bool>> Handle(UpdateQuestionCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                question.Update(request.dto.Title, request.dto.Content, request.dto.CategoryId);
            ...
            {
                _logger.LogError(ex, "Error updating question {QuestionId}", request.Id);
