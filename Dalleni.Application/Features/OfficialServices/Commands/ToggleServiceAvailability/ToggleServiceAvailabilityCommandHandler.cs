...
{
    internal sealed class ToggleServiceAvailabilityHandler: IRequestHandler<ToggleServiceAvailabilityCommand, Response<bool>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IResponseHandler _responseHandler;
        private readonly IMapper _mapper;

        public ToggleServiceAvailabilityHandler(IUnitOfWork unitOfWork, IResponseHandler responseHandler, IMapper mapper)
        {
        ...
        public async Task<Response<bool>> Handle(ToggleServiceAvailabilityCommand request,CancellationToken cancellationToken)
        {
